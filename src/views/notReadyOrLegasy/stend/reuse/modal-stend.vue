      ...
      <div class="modal-wrapper">
        <div class="modal-container grid-stend">
          <div class="modal-header">
            <img class="modal--logo--img" src="../../../assets/img/logo-fso.png" alt="" srcset="">
          </div>
          ...
          <div class="modal-body">
            <div class="modal-body-header">
              <h5 class="modal--logo--text">ЦССИ ФСО России в Тюменской области</h5>
              <div class="line"></div>
            </div>
           <!--  <h5 class="modal--logo--text">Центр специальной связи и информации Федеральной Службы Охраны Российской Федерации в Тюменской области</h5> -->
 <!--            <div v-for='item in this.prop.news' class="hw-100">
              <article class="card card__modal">
                <div class="card--header card--header__modal">{{item.header}} 
              </div>
          ...
          <div class="modal-footer">
            <weather 
              api-key="efaad36ad7faec603bb6606735a7c30e"
              title="Погода"
              latitude="57.1497673"
